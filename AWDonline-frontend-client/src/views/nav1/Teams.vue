<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="name" label="账号" min-width="180" sortable>
			</el-table-column>
			<!--<el-table-column prop="sex" label="性别" width="100" :formatter="formatSex" sortable>
			</el-table-column>-->
			<el-table-column prop="nickname" label="队名" min-width="180" sortable>
			</el-table-column>
			<el-table-column prop="score" label="得分" min-width="100" sortable>
			</el-table-column>
			<!--<el-table-column prop="birth" label="得分" width="120" sortable>
			</el-table-column>-->
			<el-table-column prop="password" label="初始密码" min-width="180" sortable>
			</el-table-column>-->
			<!--
...
<script>
	...
	import { getTeamListPage, removeTeam, batchRemoveTeam, editTeam, addTeam } from '../../api/api';
